#!/bin/bash
#cd bin ; make clean; make NVAR=6 FMM=1 MPI=1; cd .. ; mpirun -np 2 bin/ramses3d namelist/fmm_tests/single1.nml
...
cd bin ; make clean; make NVAR=6 FMM=1 GRAV=1 MPI=1; cd .. ; mpirun -np 2 bin/ramses3d namelist/fmm_tests/single_offset1.nml
