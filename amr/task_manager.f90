...
function worker_init(mdl) result(pst)
  ...
  call mdl_add_service(pst%s%mdl,MDL_INPUT_HYDRO_GADGET,     pst,C_FUNLOC(r_input_hydro_gadget),0,0,"input_hydro_gadget")
  ...
  call mdl_add_service(pst%s%mdl,MDL_DUMP_MULTIPOLE,         pst,C_FUNLOC(r_dump_multipole),1,0,"dump_multipole")
  call mdl_add_service(pst%s%mdl,MDL_MULTIPOLE_SHIFT_DOWNWARD,pst,C_FUNLOC(r_fmm_multipole_shift_downward),1,0,"r_fmm_multipole_shift_downward")
  ...
  call mdl_add_service(pst%s%mdl,MDL_COLLECT_GLOBAL_MULTIPOLE_FMM,  pst,C_FUNLOC(r_collect_fmm_global_multipole),1,storage_size(pst%s%g%multipole_fmm_raw)/32,"collect_global_multipole_fmm")
  call mdl_add_service(pst%s%mdl,MDL_ACCUM_GLOBAL_MULTIPOLE_FMM,    pst,C_FUNLOC(r_accumulate_fmm_global_multipole),1,0,"accumulate_global_multipole_fmm")
  call mdl_add_service(pst%s%mdl,MDL_BROADCAST_GLOBAL_MULTIPOLE_FMM,pst,C_FUNLOC(r_broadcast_fmm_global_multipole),storage_size(pst%s%g%multipole_fmm_raw)/32,0,"broadcast_global_multipole_fmm")
#endif
#endif
